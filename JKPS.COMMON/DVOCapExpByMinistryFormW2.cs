...
{
    public class DVOCapExpByMinistryFormW2:DVOBase
    {
        ...
        #region Constructure
        public DVOCapExpByMinistryFormW2()
        {
        ...
        {
            get { return "uspCapExpByMinFormW2B"; }
        }

        public override string ALL_SPNAME
        {
            get { return "uspcapexpMaster_Segment"; }
        }
        ...
        public override string FIND_QUERY(ref object[] parameters)
        {
            ...
            sql.Append(" where  x0.acct_no = x1.acct_no and x0.acct_no= x2.account AND x0.acct_type = 'CAPEXP'");
