...
{
  public class DVOGLTrialBalance : DVOBase
    {
        /// <summary>
        /// Implemented by : Rohit Wadhwa
        /// Date : 11 August 2008
        /// Description :
        /// Modified by: 
        /// Modified Date : 
      ...
      public override string FIND_QUERY(ref Object[] parameters)
      {
          StringBuilder sql = new StringBuilder();
            ...
            sql.Append(" and ((stxchrtd.activity is not null and stxchrtd.activity <>0) or (stxchrtd.balance is not null and stxchrtd.balance <> 0) or (stxchrtd.this_month is not null and stxchrtd.this_month<>0)) ");
