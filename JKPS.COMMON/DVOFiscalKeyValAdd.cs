...
namespace JKPS.COMMON
{
    ...
    ///1.)     DVO For Fiscal KeyValue Add                Rajeev(D)                                 08/06/2009(DD)
    ///2.) 
    ///<summery>
    public class DVOFiscalKeyValAdd:DVOBase
    {
       private int _linkid;
       private string _acct_type;
        ...
        {
            get { return "uspfiskeyvalins"; }
        }

        public override string UPDATE_SPNAME
        {
            get { return "uspfiskeyvalupd"; }
        }

        public override string DELETE_SPNAME
        {
            get { return "uspkeyvaldel"; } //delete by linkid
        }

        public override string FIND_SPNAME
        {
            get { return "uspfiskeyvalget"; }
        }
        ...
        public string INSERT_TEMP_TABLE_FISCAL_KEY_VALADD
        {
            get { return "uspkeyvaltmpins"; }
                          
        }

        public  string FIND_KeyValAdd_TEMP_Detail_ByLinkID
        {
            get { return "uspkeyvaltmpget"; }
        }

        public string DELETE_DETAILS_BY_ROWID
        {
            get { return "uspkeyvaldetdel"; }
        }
