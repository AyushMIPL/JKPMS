...
using JKPS.COMMON;
using JKPS.DL;
namespace JKPS.BLL.PostingBLL
{
    public class BLLCheckSelectedPayroll
    {
        #region Payroll Comparison Report..

        #region Global Variables Used in Payroll Calculation..
        ...
        //************************
        List<DVOPayrollstypayid> objStypayidList = new List<DVOPayrollstypayid>();
        List<DVOPayrollstypaydd> objStypayddList = new List<DVOPayrollstypaydd>();
        List<DVOPayrollStypayod> objStypayodList = new List<DVOPayrollStypayod>();
        //************************
        ...
        public DVOPayrollautopay objCurEmpl = new DVOPayrollautopay();
        int curEmpDocNo = 0;
        ArrayList alDefectedIncCode = new ArrayList();
        ArrayList alDefectedDedCode = new ArrayList();
        ArrayList alDefectedOblCode = new ArrayList();
        //public object objTransaction = null;
        #endregion

        public DataSet CheckSelectedPayroll(string empType, string payDate)
        {

            DataSet dsFinal = new DataSet();

            #region Make DataTable object to hold Process_PayEmployee result..
            DataTable objDataTable = new DataTable();
            objDataTable.TableName = "Process_PayEmployee";
            objDataTable.Columns.Add("empl_code");
            objDataTable.Columns.Add("first_name");
            objDataTable.Columns.Add("middle_name");
            objDataTable.Columns.Add("last_name");
            objDataTable.Columns.Add("eop_date", typeof(DateTime));
            objDataTable.Columns.Add("pay_date", typeof(DateTime));
            objDataTable.Columns.Add("cash_acct");
            objDataTable.Columns.Add("department");

            objDataTable.Columns.Add("ptotal_hours", typeof(decimal));
            objDataTable.Columns.Add("pinc_gross", typeof(decimal));
            objDataTable.Columns.Add("pinc_taxable", typeof(decimal));
            objDataTable.Columns.Add("pinc_expense", typeof(decimal));
            objDataTable.Columns.Add("pcheck_amount", typeof(decimal));
            objDataTable.Columns.Add("pinc_net", typeof(decimal));
            objDataTable.Columns.Add("pded_fica", typeof(decimal));
            objDataTable.Columns.Add("pded_medicare", typeof(decimal));
            objDataTable.Columns.Add("pded_fedtax", typeof(decimal));
            objDataTable.Columns.Add("pded_statax", typeof(decimal));
            objDataTable.Columns.Add("pded_loctax", typeof(decimal));
            objDataTable.Columns.Add("pded_other", typeof(decimal));
            objDataTable.Columns.Add("pobl_fica", typeof(decimal));
            objDataTable.Columns.Add("pobl_medicare", typeof(decimal));
            objDataTable.Columns.Add("pobl_futa", typeof(decimal));
            objDataTable.Columns.Add("pobl_other", typeof(decimal));
            objDataTable.Columns.Add("pded_total", typeof(decimal));
            objDataTable.Columns.Add("pobl_total", typeof(decimal));

            objDataTable.Columns.Add("ctotal_hours", typeof(decimal));
            objDataTable.Columns.Add("cinc_gross", typeof(decimal));
            objDataTable.Columns.Add("cinc_taxable", typeof(decimal));
            objDataTable.Columns.Add("cinc_expense", typeof(decimal));
            objDataTable.Columns.Add("ccheck_amount", typeof(decimal));
            objDataTable.Columns.Add("cinc_net", typeof(decimal));
            objDataTable.Columns.Add("cded_fica", typeof(decimal));
            objDataTable.Columns.Add("cded_medicare", typeof(decimal));
            objDataTable.Columns.Add("cded_fedtax", typeof(decimal));
            objDataTable.Columns.Add("cded_statax", typeof(decimal));
            objDataTable.Columns.Add("cded_loctax", typeof(decimal));
            objDataTable.Columns.Add("cded_other", typeof(decimal));
            objDataTable.Columns.Add("cobl_fica", typeof(decimal));
            objDataTable.Columns.Add("cobl_medicare", typeof(decimal));
            objDataTable.Columns.Add("cobl_futa", typeof(decimal));
            objDataTable.Columns.Add("cobl_other", typeof(decimal));
            objDataTable.Columns.Add("cded_total", typeof(decimal));
            objDataTable.Columns.Add("cobl_total", typeof(decimal));
            objDataTable.Columns.Add("IsProcessed");
            objDataTable.Columns.Add("doc_no", typeof(Int32));
            objDataTable.Columns.Add("address1");
            objDataTable.Columns.Add("address2");
            objDataTable.Columns.Add("gender");
            #endregion

            #region Make DataTable object to hold Incomes..
            DataTable objDtlIncoms = new DataTable();
            objDtlIncoms.TableName = "Stypayid";
            objDtlIncoms.Columns.Add("emp_code");
            objDtlIncoms.Columns.Add("doc_no", typeof(int));
            objDtlIncoms.Columns.Add("line_no", typeof(int));
            objDtlIncoms.Columns.Add("pinc_code");
            objDtlIncoms.Columns.Add("pinc_rate", typeof(decimal));
            objDtlIncoms.Columns.Add("pnumber", typeof(decimal));
            objDtlIncoms.Columns.Add("phours", typeof(decimal));
            objDtlIncoms.Columns.Add("pamount", typeof(decimal));
            objDtlIncoms.Columns.Add("cinc_code");
            objDtlIncoms.Columns.Add("cinc_rate", typeof(decimal));
            objDtlIncoms.Columns.Add("cnumber", typeof(decimal));
            objDtlIncoms.Columns.Add("chours", typeof(decimal));
            objDtlIncoms.Columns.Add("camount", typeof(decimal));
            objDtlIncoms.Columns.Add("IsProcessed");
            ;
            #endregion

            #region Make DataTable object to hold Deductions..
            DataTable objDtlDeduction = new DataTable();
            objDtlDeduction.TableName = "Stypaydd";
            objDtlDeduction.Columns.Add("emp_code");
            objDtlDeduction.Columns.Add("doc_no", typeof(int));
            objDtlDeduction.Columns.Add("ded_code");
            objDtlDeduction.Columns.Add("pded_rate", typeof(decimal));
            objDtlDeduction.Columns.Add("pamount", typeof(decimal));
            objDtlDeduction.Columns.Add("cded_rate", typeof(decimal));
            objDtlDeduction.Columns.Add("camount", typeof(decimal));
            objDtlDeduction.Columns.Add("IsProcessed");
            #endregion

            #region Make DataTable object to hold Obligations..
            DataTable objDtlObligation = new DataTable();
            objDtlObligation.TableName = "Stypayod";
            objDtlObligation.Columns.Add("emp_code");
            objDtlObligation.Columns.Add("doc_no", typeof(int));
            objDtlObligation.Columns.Add("line_no");
            objDtlObligation.Columns.Add("obl_code");
            objDtlObligation.Columns.Add("pobl_rate", typeof(decimal));
            objDtlObligation.Columns.Add("pamount", typeof(decimal));
            objDtlObligation.Columns.Add("cobl_rate", typeof(decimal));
            objDtlObligation.Columns.Add("camount", typeof(decimal));
            objDtlObligation.Columns.Add("IsProcessed");
            #endregion
            ...
            try
            {
                #region  Get List of employees processed on 'payDate'
                List<DVOPayrollProcess_PayEmployee> objProcessedEmpList = ListofPersionsProcessed(empType, payDate);

                string arrDocNo = string.Empty;
                if (objProcessedEmpList.Count > 0)
                {
                    arrDocNo = string.Empty;
                    foreach (DVOPayrollProcess_PayEmployee o in objProcessedEmpList)
                    {
                        if (arrDocNo.Length > 0)
                            arrDocNo += "," + o.Doc_no.ToString();
                        else
                            arrDocNo = o.Doc_no.ToString();
                    }
                    objStypayidList = GetAllIncomesPaid(arrDocNo);
                    objStypayddList = GetAllDeductionPaid(arrDocNo);
                    objStypayodList = GetAllObligationPaid(arrDocNo);
                }
                #endregion

                #region Get Employees info to be processed on 'payDate'
                List<DVOPayrollautopay> objEmpToBeProcessedList = ListofPersionsToBeProcessed(empType, payDate);
                if (objEmpToBeProcessedList.Count > 0)
                {
                    DVOPayrollProcess_PayEmployee objProcessedStypare = new DVOPayrollProcess_PayEmployee();
                    //***************************************************************
                    int _currentDocNo = 0;
                    ...
                    //****************************************************************
                    DVOPayrollautopay objpayautosearchdata = new DVOPayrollautopay();
                    objpayautosearchdata.Employee_Type = empType;
                    objpayautosearchdata.Payroll_Date = DateTime.ParseExact(payDate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);
                    LoadAllTimeCardIncomes(objpayautosearchdata);
                    LoadAllEmployeeIncomes();
                    LoadAllDeductions();
                    LoadAllded_taxcalc(payDate);
                    LoadAllded_taxcalc_Detail(payDate);
                    LoadAllObligations();
                    LoadAllDupSSN();
                    LoadAllDupSSNPay();
                    //****************************************************************
                    ...
                    foreach (DVOPayrollautopay objPayrollautopay in objEmpToBeProcessedList)
                    {
                        objCurEmpl = objPayrollautopay;
                        objProcessedStypare = new DVOPayrollProcess_PayEmployee();
                        //Calulate Payroll again to verify whether it was calculated correct or not.
                        #region Calculate Payroll
                        curEmpDocNo = 0;
                        object[] parameters = new object[1];
                        parameters[0] = objPayrollautopay.SocSecNum.Trim();
                        //get from DB if it is a duplicate ssn code 
                        if (dsDuplicateSSN != null && dsDuplicateSSN.Tables.Count > 0)
                        {
                            DataRow[] drs = dsDuplicateSSN.Tables[0].Select("SSN = '" + objPayrollautopay.SocSecNum.Trim() + "'");
                            if (drs.Length > 0)
                                dup_ssn = drs[0]["COUNT"] != DBNull.Value ? Convert.ToInt32(drs[0]["COUNT"]) : 0;
                        }
                        empl_ssn = objPayrollautopay.SocSecNum.Trim();
                        if (dup_ssn > 1)
                        {
                            if (dsDuplicateSSNPay != null && dsDuplicateSSNPay.Tables.Count > 0)
                            {
                                DataRow[] drs = dsDuplicateSSNPay.Tables[0].Select("SSN='" + objPayrollautopay.SocSecNum.Trim() + "' AND EMPL_CODE <> '" + objPayrollautopay.EmplCode.Trim() + "'");
                                if (drs.Length > 0)
                        ...
                        objPayrollProcess_PayEmployee.EmplCode = objPayrollautopay.EmplCode;
                        ...
                        if (objPayrollautopay.DirDept == "Y")
                        {
                        ...
                        objPayrollProcess_PayEmployee.StateTaxCode = objPayrollautopay.StaTaxCode;
                        if (objPayrollautopay.Flexdeptacctno == 0)
                        {
                            //set value from control table is there is no value for Employee cash account .
                            objPayrollautopay.Flexdeptacctno = objstycntrcList[0].cash_acct;
                        }

                        objPayrollProcess_PayEmployee.Cash_acct_no = objPayrollautopay.Flexdeptacctno;
                        objPayrollProcess_PayEmployee.Department = objPayrollautopay.Department;

                        objPayrollIncomesglobal = LoadIncomes(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);
                        objPayrolldeductionsglobal = LoadDeductions(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);
                        objPayrollobligationsglobal = LoadObligations(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);

                        objPayrollProcess_PayEmployee = CalculatePayrolls(ref objPayrollProcess_PayEmployee);

                        #endregion
                        objProcessedStypare = objProcessedEmpList.Find(delegate(DVOPayrollProcess_PayEmployee o) { return o.EmplCode == objPayrollautopay.EmplCode; });

                        if (objProcessedStypare != null)
                        {
                            curEmpDocNo = objProcessedStypare.Doc_no;
                            #region Compare Payroll..
                            bool status = true;
                            //Compare Process_PayEmployee amounts ..
                            if (!ComparePayrollProcess_PayEmployee(ref objProcessedStypare, ref objPayrollProcess_PayEmployee, ref objDataTable))
                                status = false;

                            //Compare Incomes ..........
                            if (!CompareIncomes(ref objDtlIncoms))
                                status = false;

                            //Compare Deductions ..........
                            if (!CompareDeductions(ref objDtlDeduction))
                                status = false;

                            //Compare Oblgations ..........
                            if (!CompareObligations(ref objDtlObligation))
                                status = false;

                            if (!status)
                            {
                                //Add this employee into DataTable to show on report..
                                AddIntoProcess_PayEmployee(ref objProcessedStypare, ref objPayrollProcess_PayEmployee, ref objDataTable, true);
                                //AddDefectedIncomesIntoTable(ref objDtlIncoms);
                                //AddDefectedDeductionIntoTable(ref objDtlDeduction);
                                //AddDefectedObligationIntoTable(ref objDtlObligation);
                            }
                            #endregion
                        }
                        else
                        {
                            //Add this employee into DataTable to show on report..
                            AddIntoProcess_PayEmployee(ref objProcessedStypare, ref objPayrollProcess_PayEmployee, ref objDataTable, false);
                            AddIncomesIntoTable(ref objDtlIncoms);
                            AddDeductionIntoTable(ref objDtlDeduction);
                            AddObligationIntoTable(ref objDtlObligation);
                        }
                    }
                }
                dsFinal.Tables.Add(objDataTable);
                dsFinal.Tables.Add(objDtlIncoms);
                dsFinal.Tables.Add(objDtlDeduction);
                dsFinal.Tables.Add(objDtlObligation);
            }
            catch (Exception ex)
            {
        ...
        public List<DVOPayrollautopay> ListofPersionsToBeProcessed(string empType, string payDate)
        {
            //This function will return the Employee
            //List for which the payroll is to be processed.
            DVOPayrollautopay objpayautosearchdata = new DVOPayrollautopay();
            object[] parameters = new object[3];
            parameters[0] = empType;
            parameters[1] = payDate;
            parameters[2] = LastPay(payDate, empType);
            //parameters[2] = payDate;

            List<DVOPayrollautopay> objpayrollautopaylist = new List<DVOPayrollautopay>();
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            //DateTime EOP_DATE = DateTime.ParseExact(payDate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);

            using (DataSet ds = objDalBaseClass.GetData(objpayautosearchdata.FIND_PERSION_TO_BE_PROCESSED(ref parameters)))
            {
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    objautopay.Payroll_Date = DateTime.ParseExact(payDate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);
                    objautopay.EOP_Date = DateTime.ParseExact(payDate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);
                    objautopay.address1 = dr[25] != DBNull.Value ? dr[25].ToString().Trim() : string.Empty;
                    objautopay.address2 = dr[26] != DBNull.Value ? dr[26].ToString().Trim() : string.Empty;
                    objautopay.gender = dr[27] != DBNull.Value ? dr[27].ToString().Trim() : string.Empty;
        ...
        public List<DVOPayrollautopay> ListofPersionsToBeProcessed(string empType, string startDate, string endDate, bool IsPrintLetter)
        {
            //This function will return the Employee
            //List for which the payroll is to be processed.
            DVOPayrollautopay objpayautosearchdata = new DVOPayrollautopay();
            ...
            using (DataSet ds = objDalBaseClass.GetData(objpayautosearchdata.FIND_PERSION_TO_PRINT_LETTRER(ref parameters)))
            {
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    objautopay.LastIncDate = (dr[23] != DBNull.Value ? Convert.ToString(dr[23]).Trim() : string.Empty);
                    objautopay.RowID = (dr[24] != DBNull.Value && dr[24].ToString().Trim() != "" ? Convert.ToInt32(dr[24]) : 0);
                    objautopay.Payroll_Date = DateTime.ParseExact(startDate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);
                    objautopay.EOP_Date = DateTime.ParseExact(startDate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);
                    objautopay.address1 = dr[25] != DBNull.Value ? dr[25].ToString().Trim() : string.Empty;
                    objautopay.address2 = dr[26] != DBNull.Value ? dr[26].ToString().Trim() : string.Empty;
                    objautopay.gender = dr[27] != DBNull.Value ? dr[27].ToString().Trim() : string.Empty;
        ...
        public List<DVOPayrollautopay> ListofPersionsToBeProcessed(string empType, string startDate, string endDate)
        {
            //This function will return the Employee
            //List for which the payroll is to be processed.
            DVOPayrollautopay objpayautosearchdata = new DVOPayrollautopay();
            ...
            parameters[1] = startDate;
            parameters[2] = endDate;
            parameters[3] = LastPay(startDate, empType);
            //parameters[2] = payDate;
            ...
            using (DataSet ds = objDalBaseClass.GetData(objpayautosearchdata.FIND_WAGE_PERSION_TO_BE_PROCESSED(ref parameters)))
            {
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
        ...
        public string LastPay(string payDate, string empType)
        {
            string payPeriod = string.Empty;
            if (empType.Contains("WAGE"))
                payPeriod = "W";
            else
                payPeriod = "M";
            DateTime lastDate = DateTime.ParseExact(payDate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);
            if (payPeriod == "W")
                lastDate = lastDate.AddDays(-5);
            else
                lastDate = lastDate.AddDays(-25);
            return lastDate.ToString(DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture);
        }

        public bool ComparePayrollProcess_PayEmployee(ref DVOPayrollProcess_PayEmployee ObjP, ref DVOPayrollProcess_PayEmployee ObjC, ref DataTable objDataTable)
        {

            if ((ObjP.cash_amount == ObjC.cash_amount) && (ObjP.inc_gross == ObjC.inc_gross) && (ObjP.ded_fica == ObjC.ded_fica)
                && (ObjP.inc_taxable == ObjC.inc_taxable) && (ObjP.ded_medicare == ObjC.ded_medicare) && (ObjP.ded_fedtax == ObjC.ded_fedtax)
                && (ObjP.ded_statax == ObjC.ded_statax) && (ObjP.ded_loctax == ObjC.ded_loctax) && (ObjP.ded_other == ObjC.ded_other)
                && (ObjP.obl_futa == ObjC.obl_futa) && (ObjP.obl_fica == ObjC.obl_fica) && (ObjP.obl_medicare == ObjC.obl_medicare)
                && (ObjP.obl_other == ObjC.obl_other) && (ObjP.obl_total == ObjC.obl_total) && (ObjP.inc_net == ObjC.inc_net)
                && (ObjP.inc_expense == ObjC.inc_expense) && (ObjP.total_hours == ObjC.total_hours))
            {
                return true;
            }
            else
        ...
        public void AddIntoProcess_PayEmployee(ref DVOPayrollProcess_PayEmployee objP, ref DVOPayrollProcess_PayEmployee objC, ref DataTable objDataTable, bool IsProcessed)
        {
            if (!IsProcessed)
            {
                objP = new DVOPayrollProcess_PayEmployee();
            }
            DataRow dr = objDataTable.NewRow();
            dr["empl_code"] = objCurEmpl.EmplCode;
            dr["first_name"] = objCurEmpl.FirstName;
            dr["middle_name"] = null;
            dr["last_name"] = objCurEmpl.LastName;
            dr["eop_date"] = objCurEmpl.EOP_Date;
            dr["pay_date"] = objCurEmpl.Payroll_Date;
            dr["department"] = objCurEmpl.Department;

            dr["ptotal_hours"] = objP.total_hours != null ? objP.total_hours : 0;
            dr["pinc_gross"] = objP.inc_gross != null ? objP.inc_gross : 0;
            dr["pinc_taxable"] = objP.inc_taxable != null ? objP.inc_taxable : 0;
            dr["pinc_expense"] = objP.inc_expense != null ? objP.inc_expense : 0;
            dr["pcheck_amount"] = objP.cash_amount != null ? objP.cash_amount : 0;
            dr["pinc_net"] = objP.inc_net != null ? objP.inc_net : 0;
            dr["pded_fica"] = objP.ded_fica != null ? objP.ded_fica : 0;
            dr["pded_medicare"] = objP.ded_medicare != null ? objP.ded_medicare : 0;
            dr["pded_fedtax"] = objP.ded_fedtax != null ? objP.ded_fedtax : 0;
            dr["pded_statax"] = objP.ded_statax != null ? objP.ded_statax : 0;
            dr["pded_loctax"] = objP.ded_loctax != null ? objP.ded_loctax : 0;
            dr["pded_other"] = objP.ded_other != null ? objP.ded_other : 0;
            dr["pobl_fica"] = objP.obl_fica != null ? objP.obl_fica : 0;
            dr["pobl_medicare"] = objP.obl_medicare != null ? objP.obl_medicare : 0;
            dr["pobl_futa"] = objP.obl_futa != null ? objP.obl_futa : 0;
            dr["pobl_other"] = objP.obl_other != null ? objP.obl_other : 0;
            dr["pded_total"] = objP.ded_other != null ? objP.ded_other : 0;
            dr["pobl_total"] = objP.obl_total != null ? objP.obl_total : 0;

            dr["ctotal_hours"] = objC.total_hours != null ? objC.total_hours : 0;
            dr["cinc_gross"] = objC.inc_gross != null ? objC.inc_gross : 0;
            dr["cinc_taxable"] = objC.inc_taxable != null ? objC.inc_taxable : 0;
            dr["cinc_expense"] = objC.inc_expense != null ? objC.inc_expense : 0;
            dr["ccheck_amount"] = objC.cash_amount != null ? objC.cash_amount : 0;
            dr["cinc_net"] = objC.inc_net != null ? objC.inc_net : 0;
            dr["cded_fica"] = objC.ded_fica != null ? objC.ded_fica : 0;
            dr["cded_medicare"] = objC.ded_medicare != null ? objC.ded_medicare : 0;
            dr["cded_fedtax"] = objC.ded_fedtax != null ? objC.ded_fedtax : 0;
            dr["cded_statax"] = objC.ded_statax != null ? objC.ded_statax : 0;
            dr["cded_loctax"] = objC.ded_loctax != null ? objC.ded_loctax : 0;
            dr["cded_other"] = objC.ded_other != null ? objC.ded_other : 0;
            dr["cobl_fica"] = objC.obl_fica != null ? objC.obl_fica : 0;
            dr["cobl_medicare"] = objC.obl_medicare != null ? objC.obl_medicare : 0;
            dr["cobl_futa"] = objC.obl_futa != null ? objC.obl_futa : 0;
            dr["cobl_other"] = objC.obl_other != null ? objC.obl_other : 0;
            dr["cded_total"] = objC.ded_other != null ? objC.ded_other : 0;
            dr["cobl_total"] = objC.obl_total != null ? objC.obl_total : 0;
            if (IsProcessed)
                dr["IsProcessed"] = "Y";
            else
                dr["IsProcessed"] = "N";

            dr["doc_no"] = objP.Doc_no;
            dr["address1"] = objCurEmpl.address1;
            dr["address2"] = objCurEmpl.address2;
            dr["gender"] = objCurEmpl.gender;

            objDataTable.Rows.Add(dr);

        }

        public bool CompareIncomes(ref DataTable objDtlIncoms)
        {
            bool ProblemStatus = false;
            bool NotProcessed = false;
            DVOPayrollstypayid objIncP = null;
            //alDefectedIncCode.Clear();
            List<DVOPayrollstypayid> objCurEmpProcessedIncList = objStypayidList.FindAll(delegate(DVOPayrollstypayid o) { return o.Doc_no == curEmpDocNo; });
            //if (objPayrollIncomesglobal.Count != objCurEmpProcessedIncList.Count)
            //{
            //    NotProcessed = true;
            //}
            //else
            //{
            foreach (DVOPayrollstypayid objC in objPayrollIncomesglobal)
            {
                objIncP = objCurEmpProcessedIncList.Find(delegate(DVOPayrollstypayid o) { return o.inc_code.Trim() == objC.inc_code.Trim(); });
                if (objIncP != null)
                {
                    if (objC.inc_rate == null)
                        objC.inc_rate = 0;
                    if (objC.number == null)
                        objC.number = 0;
                    if (objC.hours == null)
                    ...
                    if (objIncP.inc_rate == null)
                        objIncP.inc_rate = 0;
                    if (objIncP.number == null)
                        objIncP.number = 0;
                    if (objIncP.hours == null)
                        objIncP.hours = 0;
                    if (objIncP.amount == null)
                        objIncP.amount = 0;

                    if (!((objIncP.inc_rate == objC.inc_rate) && (objIncP.number == objC.number) && (objIncP.hours == objC.hours) && (objIncP.amount == objC.amount)))
                    {
                        //alDefectedIncCode.Add(objIncP.inc_code);
                        DataRow dr = objDtlIncoms.NewRow();
                        dr["emp_code"] = objCurEmpl.EmplCode;
                        dr["doc_no"] = objIncP.Doc_no;
                        dr["line_no"] = objIncP.line_no;
                        dr["pinc_code"] = objIncP.inc_code;
                        dr["pinc_rate"] = objIncP.inc_rate != null ? objIncP.inc_rate : 0;
                        dr["pnumber"] = objIncP.number != null ? objIncP.number : 0;
                        dr["phours"] = objIncP.hours != null ? objIncP.hours : 0;
                        dr["pamount"] = objIncP.amount != null ? objIncP.amount : 0;
                        dr["cinc_rate"] = objC.inc_rate != null ? objC.inc_rate : 0;
                        dr["cnumber"] = objC.number != null ? objC.number : 0;
                        dr["chours"] = objC.hours != null ? objC.hours : 0;
                        dr["camount"] = objC.amount != null ? objC.amount : 0;
                        dr["IsProcessed"] = "Y";
                        objDtlIncoms.Rows.Add(dr);
                        ProblemStatus = true;
                        //break;
                    }
                    objCurEmpProcessedIncList.Remove(objIncP);
                }
                else
                {
                    //alDefectedIncCode.Add(objC.inc_code);
                    DataRow dr = objDtlIncoms.NewRow();
                    dr["emp_code"] = objCurEmpl.EmplCode;
                    dr["doc_no"] = 0;
                    dr["line_no"] = 0;
                    dr["pinc_code"] = objC.inc_code;
                    dr["pinc_rate"] = 0;
                    dr["pnumber"] = 0;
                    dr["phours"] = 0;
                    dr["pamount"] = 0;
            ...
            foreach (DVOPayrollstypayid objP in objCurEmpProcessedIncList)
            {
                //alDefectedIncCode.Add(objL.inc_code);
                DataRow dr = objDtlIncoms.NewRow();
                dr["emp_code"] = objCurEmpl.EmplCode;
                dr["doc_no"] = objP.Doc_no;
                dr["line_no"] = objP.line_no;
                dr["pinc_code"] = objP.inc_code;
                dr["pinc_rate"] = objP.inc_rate != null ? objP.inc_rate : 0;
                dr["pnumber"] = objP.number != null ? objP.number : 0;
                dr["phours"] = objP.hours != null ? objP.hours : 0;
                dr["pamount"] = objP.amount != null ? objP.amount : 0;
                dr["cinc_rate"] = 0;
                dr["cnumber"] = 0;
                dr["chours"] = 0;
                dr["camount"] = 0;
        ...
        public bool CompareDeductions(ref DataTable objDtlDeduction)
        {
            bool ProblemStatus = false;
            bool NotProcessed = false;
            //alDefectedDedCode.Clear();
            DVOPayrollstypaydd objDedP = null;
            List<DVOPayrollstypaydd> objCurEmpProcessedDedList = objStypayddList.FindAll(delegate(DVOPayrollstypaydd o) { return o.Doc_no == curEmpDocNo; });

            //if (objPayrolldeductionsglobal.Count != objCurEmpProcessedDedList.Count)
            //{
            //    NotProcessed = true;
            //}
            //else
            //{
            foreach (DVOPayrollstypaydd objC in objPayrolldeductionsglobal)
            {
                objDedP = objCurEmpProcessedDedList.Find(delegate(DVOPayrollstypaydd o) { return o.ded_code.Trim() == objC.ded_code.Trim(); });
                if (objDedP != null)
                {
                    if (objDedP.ded_rate == null)
                        objDedP.ded_rate = 0;
                    if (objC.ded_rate == null)
                        objC.ded_rate = 0;
                    if (objDedP.amount == null)
                        objDedP.amount = 0;
                    if (objC.amount == null)
                        objC.amount = 0;
                    if (!((objDedP.ded_rate == objC.ded_rate) && (objDedP.amount == objC.amount)))
                    {
                        //alDefectedDedCode.Add(objDedP.ded_code);
                        DataRow dr = objDtlDeduction.NewRow();
                        dr["emp_code"] = objCurEmpl.EmplCode;
                        dr["doc_no"] = objDedP.Doc_no;
                        dr["ded_code"] = objDedP.ded_code;
                        dr["pded_rate"] = objDedP.ded_rate != null ? objDedP.ded_rate : 0;
                        dr["pamount"] = objDedP.amount != null ? objDedP.amount : 0;
                        dr["cded_rate"] = objC.ded_rate != null ? objC.ded_rate : 0;
                        dr["camount"] = objC.amount != null ? objC.amount : 0;
                        dr["IsProcessed"] = "Y";
                        objDtlDeduction.Rows.Add(dr);
                        ProblemStatus = true;
                        //break;
                    }
                    objCurEmpProcessedDedList.Remove(objDedP);
                }
                else
                {
                    //alDefectedDedCode.Remove(objC.ded_code);
                    DataRow dr = objDtlDeduction.NewRow();
                    dr["emp_code"] = objCurEmpl.EmplCode;
                    dr["doc_no"] = 0;
                    dr["ded_code"] = objC.ded_code;
                    dr["pded_rate"] = 0;
                    dr["pamount"] = 0;
                    dr["cded_rate"] = objC.ded_rate != null ? objC.ded_rate : 0;
                    dr["camount"] = objC.amount != null ? objC.amount : 0;
            ...
            foreach (DVOPayrollstypaydd objP in objCurEmpProcessedDedList)
            {
                //alDefectedDedCode.Add(objL.ded_code);
                DataRow dr = objDtlDeduction.NewRow();
                dr["emp_code"] = objCurEmpl.EmplCode;
                dr["doc_no"] = objP.Doc_no;
                dr["ded_code"] = objP.ded_code;
                dr["pded_rate"] = objP.ded_rate != null ? objP.ded_rate : 0;
                dr["pamount"] = objP.amount != null ? objP.amount : 0;
                dr["cded_rate"] = 0;
                dr["camount"] = 0;
                dr["IsProcessed"] = "Y";
        ...
        public bool CompareObligations(ref DataTable objDtlObligation)
        {
            bool ProblemStatus = false;
            bool NotProcessed = false;
            DVOPayrollStypayod objOblP = null;
            //alDefectedOblCode.Clear();
            List<DVOPayrollStypayod> objCurEmpProcessedOblList = objStypayodList.FindAll(delegate(DVOPayrollStypayod o) { return o.Doc_no == curEmpDocNo; });

            //if (objPayrollobligationsglobal.Count != objCurEmpProcessedOblList.Count)
            //{
            //    NotProcessed = true;
            //}
            //else
            //{
            foreach (DVOPayrollStypayod objC in objPayrollobligationsglobal)
            {
                objOblP = objCurEmpProcessedOblList.Find(delegate(DVOPayrollStypayod o) { return o.obl_code.Trim() == objC.obl_code.Trim(); });
                if (objOblP != null)
                {
                    if (objOblP.obl_rate == null)
                        objOblP.obl_rate = 0;
                    if (objC.obl_rate == null)
                        objC.obl_rate = 0;
                    if (objOblP.amount == null)
                        objOblP.amount = 0;
                    if (objC.amount == null)
                        objC.amount = 0;
                    if (!((objOblP.obl_rate == objC.obl_rate) && (objOblP.amount == objC.amount)))
                    {
                        //alDefectedOblCode.Add(objOblP.obl_code);
                        DataRow dr = objDtlObligation.NewRow();
                        dr["emp_code"] = objCurEmpl.EmplCode;
                        dr["doc_no"] = objOblP.Doc_no;
                        dr["line_no"] = objOblP.line_no;
                        dr["obl_code"] = objOblP.obl_code;
                        dr["pobl_rate"] = objOblP.obl_rate != null ? objOblP.obl_rate : 0;
                        dr["pamount"] = objOblP.amount != null ? objOblP.amount : 0;
                        dr["cobl_rate"] = objC.obl_rate != null ? objC.obl_rate : 0;
                        dr["camount"] = objC.amount != null ? objC.amount : 0;
                        dr["IsProcessed"] = "Y";
                        objDtlObligation.Rows.Add(dr);
                        ProblemStatus = true;
                        //break;
                    }
                    objCurEmpProcessedOblList.Remove(objOblP);
                }
                else
                {
                    //alDefectedOblCode.Add(objC.obl_code);
                    DataRow dr = objDtlObligation.NewRow();
                    dr["emp_code"] = objCurEmpl.EmplCode;
                    dr["doc_no"] = 0;
                    dr["line_no"] = 0;
                    dr["obl_code"] = objC.obl_code;
                    dr["pobl_rate"] = 0;
                    dr["pamount"] = 0;
                    dr["cobl_rate"] = objC.obl_rate != null ? objC.obl_rate : 0;
                    dr["camount"] = objC.amount != null ? objC.amount : 0;
            ...
            foreach (DVOPayrollStypayod objP in objCurEmpProcessedOblList)
            {
                //alDefectedOblCode.Add(objL.obl_code);
                DataRow dr = objDtlObligation.NewRow();
                dr["emp_code"] = objCurEmpl.EmplCode;
                dr["doc_no"] = objP.Doc_no;
                dr["line_no"] = objP.line_no;
                dr["obl_code"] = objP.obl_code;
                dr["pobl_rate"] = objP.obl_rate != null ? objP.obl_rate : 0;
                dr["pamount"] = objP.amount != null ? objP.amount : 0;
                dr["cobl_rate"] = 0;
                dr["camount"] = 0;
                dr["IsProcessed"] = "Y";
        ...
        public void AddIncomesIntoTable(ref DataTable objDtlIncoms)
        {
            DVOPayrollstypayid objIncP = null;
            List<DVOPayrollstypayid> objCurEmpProcessedIncList = objStypayidList.FindAll(delegate(DVOPayrollstypayid o) { return o.Doc_no == curEmpDocNo; });
            foreach (DVOPayrollstypayid objC in objPayrollIncomesglobal)
            ...
            foreach (DVOPayrollstypayid objP in objCurEmpProcessedIncList)
            {
                DataRow[] dra = objDtlIncoms.Select("pinc_code='" + objP.inc_code.Trim() + "'");
                if (dra.Length <= 0)
                {
                    DataRow dr = objDtlIncoms.NewRow();
                    dr["emp_code"] = objCurEmpl.EmplCode;
        ...
        public void AddDefectedIncomesIntoTable(ref DataTable objDtlIncoms)
        {
            List<DVOPayrollstypayid> objCurEmpProcessedIncList = objStypayidList.FindAll(delegate(DVOPayrollstypayid o) { return o.Doc_no == curEmpDocNo; });
            string inc_code = string.Empty;
            DVOPayrollstypayid objIncP = null;
            DVOPayrollstypayid objC = null;
            for (int i = 0; i < alDefectedIncCode.Count; i++)
            {

                inc_code = alDefectedIncCode[i].ToString();
                objIncP = objCurEmpProcessedIncList.Find(delegate(DVOPayrollstypayid o) { return o.inc_code.Trim() == inc_code; });
                objC = objPayrollIncomesglobal.Find(delegate(DVOPayrollstypayid o) { return o.inc_code.Trim() == inc_code; });
                if (objC == null)
                    objC = new DVOPayrollstypayid();
                if (objIncP == null)
                    objIncP = new DVOPayrollstypayid();
                DataRow dr = objDtlIncoms.NewRow();
                dr["emp_code"] = objCurEmpl.EmplCode;
                dr["doc_no"] = objIncP.Doc_no;
                dr["line_no"] = objIncP.line_no;
                dr["pinc_code"] = inc_code;
                dr["pinc_rate"] = objIncP.inc_rate != null ? objIncP.inc_rate : 0;
                dr["pnumber"] = objIncP.number != null ? objIncP.number : 0;
                dr["phours"] = objIncP.hours != null ? objIncP.hours : 0;
                dr["pamount"] = objIncP.amount != null ? objIncP.amount : 0;
        ...
        public void AddDeductionIntoTable(ref DataTable objDtlDeduction)
        {
            ...
            {
                DataRow dr = objDtlDeduction.NewRow();
                objDedP = objCurEmpProcessedDedList.Find(delegate(DVOPayrollstypaydd o) { return o.ded_code == objC.ded_code.Trim(); });
                if (objDedP != null)
                {
                    dr["emp_code"] = objCurEmpl.EmplCode;
                    dr["doc_no"] = objDedP.Doc_no;
            ...
            foreach (DVOPayrollstypaydd objP in objCurEmpProcessedDedList)
            {
                DataRow[] dra = objDtlDeduction.Select("ded_code='" + objP.ded_code.Trim() + "'");
                if (dra.Length <= 0)
                {
                    DataRow dr = objDtlDeduction.NewRow();
                    dr["emp_code"] = objCurEmpl.EmplCode;
        ...
        public void AddDefectedDeductionIntoTable(ref DataTable objDtlDeduction)
        {

            DVOPayrollstypaydd objDedP = null;
            DVOPayrollstypaydd objC = null;
            List<DVOPayrollstypaydd> objCurEmpProcessedDedList = objStypayddList.FindAll(delegate(DVOPayrollstypaydd o) { return o.Doc_no == curEmpDocNo; });
            string ded_code = string.Empty;

            for (int i = 0; i < alDefectedDedCode.Count; i++)
            {

                ded_code = alDefectedDedCode[i].ToString();
                objDedP = objCurEmpProcessedDedList.Find(delegate(DVOPayrollstypaydd o) { return o.ded_code == ded_code; });
                objC = objPayrolldeductionsglobal.Find(delegate(DVOPayrollstypaydd o) { return o.ded_code == ded_code; });
                if (objDedP == null)
                    objDedP = new DVOPayrollstypaydd();
                if (objC == null)
                    objC = new DVOPayrollstypaydd();
                DataRow dr = objDtlDeduction.NewRow();
                dr["emp_code"] = objCurEmpl.EmplCode;
                dr["doc_no"] = objDedP.Doc_no;
                dr["ded_code"] = ded_code;
                dr["pded_rate"] = objDedP.ded_rate != null ? objDedP.ded_rate : 0;
                dr["pamount"] = objDedP.amount != null ? objDedP.amount : 0;
                dr["cded_rate"] = objC.ded_rate != null ? objC.ded_rate : 0;
                dr["camount"] = objC.amount != null ? objC.amount : 0;
        ...
        public void AddObligationIntoTable(ref DataTable objDtlObligation)
        {
            ...
            {
                DataRow dr = objDtlObligation.NewRow();
                objOblP = objCurEmpProcessedOblList.Find(delegate(DVOPayrollStypayod o) { return o.obl_code == objC.obl_code.Trim(); });
                if (objOblP != null)
                {
                    dr["emp_code"] = objCurEmpl.EmplCode;
                    dr["doc_no"] = objOblP.Doc_no;
            ...
            foreach (DVOPayrollStypayod objP in objCurEmpProcessedOblList)
            {
                DataRow[] dra = objDtlObligation.Select("obl_code='" + objP.obl_code.Trim() + "'");
                if (dra.Length <= 0)
                {
                    DataRow dr = objDtlObligation.NewRow();
                    dr["emp_code"] = objCurEmpl.EmplCode;
        ...
        public void AddDefectedObligationIntoTable(ref DataTable objDtlObligation)
        {

            DVOPayrollStypayod objOblP = null;
            DVOPayrollStypayod objC = null;
            List<DVOPayrollStypayod> objCurEmpProcessedOblList = objStypayodList.FindAll(delegate(DVOPayrollStypayod o) { return o.Doc_no == curEmpDocNo; });

            string obl_code = string.Empty;

            for (int i = 0; i < alDefectedOblCode.Count; i++)
            {
                DataRow dr = objDtlObligation.NewRow();
                obl_code = alDefectedOblCode[i].ToString();
                objOblP = objCurEmpProcessedOblList.Find(delegate(DVOPayrollStypayod o) { return o.obl_code == obl_code; });
                objC = objPayrollobligationsglobal.Find(delegate(DVOPayrollStypayod o) { return o.obl_code == obl_code; });
                if (objOblP == null)
                    objOblP = new DVOPayrollStypayod();
                if (objC == null)
                    objC = new DVOPayrollStypayod();


                dr["emp_code"] = objCurEmpl.EmplCode;
                dr["doc_no"] = objOblP.Doc_no;
                dr["line_no"] = objOblP.line_no;
                dr["obl_code"] = obl_code;
                dr["pobl_rate"] = objOblP.obl_rate != null ? objOblP.obl_rate : 0;
                dr["pamount"] = objOblP.amount != null ? objOblP.amount : 0;
                dr["cobl_rate"] = objC.obl_rate != null ? objC.obl_rate : 0;
                dr["camount"] = objC.amount != null ? objC.amount : 0;
        ...
        #region Get Processed information of persions..
        public List<DVOPayrollProcess_PayEmployee> ListofPersionsProcessed(string empType, string payDate)
        {
            List<DVOPayrollProcess_PayEmployee> ListProcess_PayEmployee = new List<DVOPayrollProcess_PayEmployee>();
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            DVOPayrollautopay obj = new DVOPayrollautopay();
            try
            {
                ...
                using (DataSet ds = objDalBaseClass.GetData(obj.FIND_PERSION_PROCESSED(ref parameters)))
                {

                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        objProcess_PayEmployee = new DVOPayrollProcess_PayEmployee();
                        objProcess_PayEmployee.Doc_no = dr["doc_no"] != DBNull.Value ? Convert.ToInt32(dr["doc_no"]) : 0;
                        objProcess_PayEmployee.EmplCode = dr["empl_code"] != DBNull.Value ? Convert.ToString(dr["empl_code"]).Trim() : string.Empty;
                        objProcess_PayEmployee.pay_date = dr["pay_date"] != DBNull.Value ? Convert.ToDateTime(dr["pay_date"]) : Convert.ToDateTime("01/01/1900");
                        objProcess_PayEmployee.eop_date = dr["eop_date"] != DBNull.Value ? Convert.ToDateTime(dr["eop_date"]) : Convert.ToDateTime("01/01/1900");
                        objProcess_PayEmployee.print_check = dr["print_check"] != DBNull.Value ? Convert.ToString(dr["print_check"]).Trim() : string.Empty;
                        objProcess_PayEmployee.Cash_acct_no = dr["cash_acct_no"] != DBNull.Value ? Convert.ToInt32(dr["cash_acct_no"]) : 0;
                        objProcess_PayEmployee.Department = dr["department"] != DBNull.Value ? Convert.ToString(dr["department"]).Trim() : string.Empty;
                        objProcess_PayEmployee.cash_amount = dr["cash_amount"] != DBNull.Value ? Convert.ToDecimal(dr["cash_amount"]) : 0;
                        objProcess_PayEmployee.check_no = dr["check_no"] != DBNull.Value ? Convert.ToInt32(dr["check_no"]) : 0;
                        objProcess_PayEmployee.inc_gross = dr["inc_gross"] != DBNull.Value ? Convert.ToDecimal(dr["inc_gross"]) : 0;
                        objProcess_PayEmployee.ded_fica = dr["ded_fica"] != DBNull.Value ? Convert.ToDecimal(dr["ded_fica"]) : 0;
                        objProcess_PayEmployee.inc_taxable = dr["inc_taxable"] != DBNull.Value ? Convert.ToDecimal(dr["inc_taxable"]) : 0;
                        objProcess_PayEmployee.ded_medicare = dr["ded_medicare"] != DBNull.Value ? Convert.ToDecimal(dr["ded_medicare"]) : 0;
                        objProcess_PayEmployee.ded_fedtax = dr["ded_fedtax"] != DBNull.Value ? Convert.ToDecimal(dr["ded_fedtax"]) : 0;
                        objProcess_PayEmployee.ded_statax = dr["ded_statax"] != DBNull.Value ? Convert.ToDecimal(dr["ded_statax"]) : 0;
                        objProcess_PayEmployee.ded_loctax = dr["ded_loctax"] != DBNull.Value ? Convert.ToDecimal(dr["ded_loctax"]) : 0;
                        objProcess_PayEmployee.ded_other = dr["ded_other"] != DBNull.Value ? Convert.ToDecimal(dr["ded_other"]) : 0;
                        objProcess_PayEmployee.obl_futa = dr["obl_futa"] != DBNull.Value ? Convert.ToDecimal(dr["obl_futa"]) : 0;
                        objProcess_PayEmployee.obl_fica = dr["obl_fica"] != DBNull.Value ? Convert.ToDecimal(dr["obl_fica"]) : 0;
                        objProcess_PayEmployee.obl_medicare = dr["obl_medicare"] != DBNull.Value ? Convert.ToDecimal(dr["obl_medicare"]) : 0;
                        objProcess_PayEmployee.obl_other = dr["obl_other"] != DBNull.Value ? Convert.ToDecimal(dr["obl_other"]) : 0;
                        objProcess_PayEmployee.inc_net = dr["inc_net"] != DBNull.Value ? Convert.ToDecimal(dr["inc_net"]) : 0;
                        objProcess_PayEmployee.inc_expense = dr["inc_expense"] != DBNull.Value ? Convert.ToDecimal(dr["inc_expense"]) : 0;
                        objProcess_PayEmployee.total_hours = dr["total_hours"] != DBNull.Value ? Convert.ToDecimal(dr["total_hours"]) : 0;
                        objProcess_PayEmployee.ok_to_post = dr["ok_to_post"] != DBNull.Value ? Convert.ToString(dr["ok_to_post"]).Trim() : string.Empty;
                        objProcess_PayEmployee.accrue_sick = dr["accrue_sick"] != DBNull.Value ? Convert.ToString(dr["accrue_sick"]).Trim() : string.Empty;
                        objProcess_PayEmployee.accrue_vac = dr["accrue_vac"] != DBNull.Value ? Convert.ToString(dr["accrue_vac"]).Trim() : string.Empty;
                        objProcess_PayEmployee.bonus = dr["bonus"] != DBNull.Value ? Convert.ToString(dr["bonus"]).Trim() : string.Empty;
                        objProcess_PayEmployee.deposit = dr["deposit"] != DBNull.Value ? Convert.ToString(dr["deposit"]).Trim() : string.Empty;
                        objProcess_PayEmployee.obl_total = dr["obl_total"] != DBNull.Value ? Convert.ToDecimal(dr["obl_total"]) : 0;
                        ListProcess_PayEmployee.Add(objProcess_PayEmployee);
            ...
            return ListProcess_PayEmployee;
        }



        public List<DVOPayrollProcess_PayEmployee> ListofPersionsProcessed(string empType, string startDate, string endDate)
        {
            List<DVOPayrollProcess_PayEmployee> ListProcess_PayEmployee = new List<DVOPayrollProcess_PayEmployee>();
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            ...
            try
            {
                ...
                parameters[2] = endDate;
                DVOPayrollProcess_PayEmployee objProcess_PayEmployee = new DVOPayrollProcess_PayEmployee();
                using (DataSet ds = objDalBaseClass.GetData(obj.FIND_WAGE_PERSON_PROCESSED(ref parameters)))
                {
        ...
        DataSet dsAllIncomesPaid = new DataSet();
        public List<DVOPayrollstypayid> GetAllIncomesPaid(string arrDocNo)
        {
            List<DVOPayrollstypayid> ListStypayid = new List<DVOPayrollstypayid>();
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            DVOPayrollstypayid objstypayid = new DVOPayrollstypayid();
            try
            {
                object[] parameters = new object[1];
                parameters[0] = arrDocNo;
                dsAllIncomesPaid = new DataSet();
                using (DataSet ds = objDalBaseClass.GetData(objstypayid.GET_ALLPAYID(ref parameters)))
                {
                    dsAllIncomesPaid = ds.Copy();
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        DVOPayrollstypayid obj = new DVOPayrollstypayid();
                        obj.Doc_no = dr["doc_no"] != DBNull.Value ? Convert.ToInt32(dr["doc_no"]) : 0;
                        obj.line_no = dr["line_no"] != DBNull.Value ? Convert.ToInt32(dr["line_no"]) : 0;
                        obj.inc_code = dr["inc_code"] != DBNull.Value ? Convert.ToString(dr["inc_code"]).Trim() : string.Empty;
                        obj.inc_rate = dr["inc_rate"] != DBNull.Value ? Convert.ToDecimal(dr["inc_rate"]) : 0;
                        obj.number = dr["number"] != DBNull.Value ? Convert.ToDecimal(dr["number"]) : 0;
                        obj.hours = dr["hours"] != DBNull.Value ? Convert.ToDecimal(dr["hours"]) : 0;
                        obj.amount = dr["amount"] != DBNull.Value ? Convert.ToDecimal(dr["amount"]) : 0;
                        obj.acct_no = dr["acct_no"] != DBNull.Value ? Convert.ToInt32(dr["acct_no"]) : 0;
                        obj.Department = dr["Department"] != DBNull.Value ? Convert.ToString(dr["Department"]).Trim() : string.Empty;
                        obj.add_code = dr["add_code"] != DBNull.Value ? Convert.ToString(dr["add_code"]).Trim() : string.Empty;
                        obj.lo_inc_amt = dr["lo_inc_amt"] != DBNull.Value ? Convert.ToDecimal(dr["lo_inc_amt"]) : 0;
                        obj.hi_inc_amt = dr["hi_inc_amt"] != DBNull.Value ? Convert.ToDecimal(dr["hi_inc_amt"]) : 0;
                        obj.empl_code = dr["empl_code"] != DBNull.Value ? Convert.ToString(dr["empl_code"]).Trim() : string.Empty;
                        obj.inc_type = dr["inc_type"] != DBNull.Value ? Convert.ToString(dr["inc_type"]).Trim() : string.Empty;
                        obj.pay_date = dr["pay_date"] != DBNull.Value ? Convert.ToDateTime(dr["pay_date"]).ToString(DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture) : string.Empty;
                        ListStypayid.Add(obj);
                    }
        ...
        public List<DVOPayrollstypaydd> GetAllDeductionPaid(string arrDocNo)
        {
            List<DVOPayrollstypaydd> ListStypaydd = new List<DVOPayrollstypaydd>();
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            DVOPayrollstypaydd obj1 = new DVOPayrollstypaydd();
            try
            {

                object[] parameters = new object[1];
                parameters[0] = arrDocNo;
                using (DataSet ds = objDalBaseClass.GetData(obj1.GET_ALLPAYDD(ref parameters)))
                {
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        obj.Doc_no = dr["doc_no"] != DBNull.Value ? Convert.ToInt32(dr["doc_no"]) : 0;
                        obj.line_no = dr["line_no"] != DBNull.Value ? Convert.ToInt32(dr["line_no"]) : 0;
                        obj.ded_code = dr["ded_code"] != DBNull.Value ? Convert.ToString(dr["ded_code"]).Trim() : string.Empty;
                        obj.ded_rate = dr["ded_rate"] != DBNull.Value ? Convert.ToDecimal(dr["ded_rate"]) : 0;
                        obj.amount = dr["amount"] != DBNull.Value ? Convert.ToDecimal(dr["amount"]) : 0;
                        obj.acct_no = dr["acct_no"] != DBNull.Value ? Convert.ToInt32(dr["acct_no"]) : 0;
                        obj.Department = dr["Department"] != DBNull.Value ? Convert.ToString(dr["Department"]).Trim() : string.Empty;
                        obj.add_code = dr["add_code"] != DBNull.Value ? Convert.ToString(dr["add_code"]).Trim() : string.Empty;
                        obj.lo_ded_amt = dr["lo_ded_amt"] != DBNull.Value ? Convert.ToDecimal(dr["lo_ded_amt"]) : 0;
                        obj.hi_ded_amt = dr["hi_ded_amt"] != DBNull.Value ? Convert.ToDecimal(dr["hi_ded_amt"]) : 0;
                        obj.pay_date = dr["pay_date"] != DBNull.Value ? Convert.ToDateTime(dr["pay_date"]).ToString(DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture) : string.Empty;
                        ListStypaydd.Add(obj);
                    }
        ...
        public List<DVOPayrollStypayod> GetAllObligationPaid(string arrDocNo)
        {
            List<DVOPayrollStypayod> ListStypayod = new List<DVOPayrollStypayod>();
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            DVOPayrollStypayod obj1 = new DVOPayrollStypayod();
            try
            {
                object[] parameters = new object[1];
                parameters[0] = arrDocNo;
                using (DataSet ds = objDalBaseClass.GetData(obj1.GET_ALLPAYOD(ref parameters)))
                {
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        obj.Doc_no = dr["doc_no"] != DBNull.Value ? Convert.ToInt32(dr["doc_no"]) : 0;
                        obj.line_no = dr["line_no"] != DBNull.Value ? Convert.ToInt32(dr["line_no"]) : 0;
                        obj.obl_code = dr["obl_code"] != DBNull.Value ? Convert.ToString(dr["obl_code"]).Trim() : string.Empty;
                        obj.obl_rate = dr["obl_rate"] != DBNull.Value ? Convert.ToDecimal(dr["obl_rate"]) : 0;
                        obj.amount = dr["amount"] != DBNull.Value ? Convert.ToDecimal(dr["amount"]) : 0;
                        obj.acct_no = dr["acct_no"] != DBNull.Value ? Convert.ToInt32(dr["acct_no"]) : 0;
                        obj.Department = dr["Department"] != DBNull.Value ? Convert.ToString(dr["Department"]).Trim() : string.Empty;
                        obj.add_code = dr["add_code"] != DBNull.Value ? Convert.ToString(dr["add_code"]).Trim() : string.Empty;
                        obj.bal_acct_no = dr["bal_acct_no"] != DBNull.Value ? Convert.ToInt32(dr["bal_acct_no"]) : 0;
                        obj.bal_dept = dr["bal_dept"] != DBNull.Value ? Convert.ToString(dr["bal_dept"]).Trim() : string.Empty;
                        obj.pay_date = dr["pay_date"] != DBNull.Value ? Convert.ToDateTime(dr["pay_date"]).ToString(DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture) : string.Empty;
                        ListStypayod.Add(obj);
                    }
        ...
        public void LoadAllEmployeeIncomes()
        {
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            try
        ...
        public void LoadAllded_taxcalc(string payrollDate)
        {
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            try
        ...
        public void LoadAllded_taxcalc_Detail(string payrollDate)
        {
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            try
        ...
        public void LoadAllObligations()
        {
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            DALBaseClass objDalBaseClass = objDALBaseClassHelper.GetDAL();
            try
        ...
        public List<DVOPayrollstypayid> LoadIncomes(string EmployeeCode, DateTime EopDate, string FlexacctType, string FlexDepartment)
        {
            ...
            //        // object Maxlineno1 = null;
            //        //// = objDalBaseClass.ExecuteScalar_ByTransaction(ref objTransaction, ref parameters, (new DVOPayrollautopay()).EMPLOYEEMAXLINENOGET);
            //        // if (Maxlineno1 == null)
            //        // {
            //        //     Maxlineno = 0;
                ...
                case "G":
                    {
                        ...
                        else
                        {
                            ...
                            objPayrolldeductionsglobal[i].amount = ded_taxcalc(i, objpayrollProcess_PayEmployee.inc_taxable ?? 0, objCurEmpl.PayPeriod);//make nullable decimal By Rahul
                        }
                        break;
                    }
        ...
        public void CalculateIncomeChanges(string IncomeCodeType, decimal IncomeAmount, out decimal GrossIncomeChange, out decimal TaxableIncomeChange, out decimal FicaWagesChange, out decimal FutaWagesChange)
        {
            GrossIncomeChange = 0;
            FicaWagesChange = 0;
            FutaWagesChange = 0;
        ...
        //                DataRow[] drs = dsAllDeductions.Tables[0].Select("empl_code='" + objpayrollProcess_PayEmployee.EmplCode.Trim() + "' AND ded_code='" + objPayrolldeductionsglobal[i].ded_code.Trim() + "'");
        //                if (drs.Length > 0)
        //                    objPayrolldeductionsglobal[i].ded_ytd = drs[0]["ded_ytd"] != DBNull.Value ? Convert.ToDecimal(drs[0]["ded_ytd"]) : 0;
        //            }
        //            //object[] parameter1 = new object[2];
        //            //parameter1[0] = objpayrollProcess_PayEmployee.EmplCode;
        ...
        //                DataRow[] drs = dsAllObligations.Tables[0].Select("empl_code='" + objpayrollProcess_PayEmployee.EmplCode.Trim() + "' AND obl_code='" + objPayrollobligationsglobal[i].obl_code.Trim() + "'");
        //                if (drs.Length > 0)
        //                    objPayrollobligationsglobal[i].obl_ytd = drs[0]["obl_ytd"] != DBNull.Value ? Convert.ToDecimal(drs[0]["obl_ytd"]) : 0;
        //            }
        ...
        public void LoadAllTimeCardIncomes(DVOPayrollautopay objpayautosearchdata)
        {
            ...
            try
            {
                ...
                parameters[6] = "";
                parameters[7] = "";
                parameters[8] = objpayautosearchdata.Payroll_Date.ToString(DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture);
        ...
        public decimal state_calc(int n)
        {
            ...
            else
            {
                ...
                {
                    statax_amount = ded_taxcalc(n, wage_amount, objCurEmpl.PayPeriod);
        ...
        public decimal ded_fedgrs(int n, decimal tax_wages, string pay_period)
        {
            ...
            if (objCurEmpl.StateAllow == 0)
            {
                objCurEmpl.StateAllow = objCurEmpl.Allowances;
            }
            if (objPayrolldeductionsglobal[n].ded_code == objCurEmpl.StaTaxCode)
            {
                t_total = Convert.ToDecimal(BPfunctions.Al_Round("a", tax_wages - (objCurEmpl.StateAllow * allow_amt)));
            }
            else
            {
                t_total = Convert.ToDecimal(BPfunctions.Al_Round("a", tax_wages - (objCurEmpl.Allowances * allow_amt)));
            }
            if (t_total < 0)
            {
                t_total = 0;
            ...
            if (year_is_current)
            {
                if (dsAllDedTaxCalcDetail != null && dsAllDedTaxCalcDetail.Tables.Count > 0)
                {
                    DataRow[] drs = dsAllDedTaxCalcDetail.Tables[0].Select("ded_code = '" + objstycntrcList[0].fedtax_code.Trim()
                        ...
                        + " AND marital_stat = '" + objCurEmpl.MaritalStat.Trim() + "'");
                    if (drs.Length > 0)
                    {
            ...
            if (year_is_current)
            {
                if (dsAllDedTaxCalcDetail != null && dsAllDedTaxCalcDetail.Tables.Count > 0)
                {
                    DataRow[] drs = dsAllDedTaxCalcDetail.Tables[0].Select("ded_code = '" + objPayrolldeductionsglobal[n].ded_code.Trim()
                       ...
                       + "' AND over_amt < " + t_total.ToString()
                       + " AND marital_stat = '" + objCurEmpl.MaritalStat.Trim() + "'", "base_amt");
                    Int32 CorrectSlab = 0;
        ...
        #region Deduction & Obligation Comparison ..

        public DataSet GetComparedDedAndOblResult(string empType, string payDate,bool IsPrintLetter)
        {
            ...
            try
            {
                ...
                #region Get Employees info to be processed on 'payDate'
                List<DVOPayrollautopay> objEmpToBeProcessedList = new List<DVOPayrollautopay>();
                if (IsPrintLetter)
                    objEmpToBeProcessedList=ListofPersionsToBeProcessed(empType, payDate, "", true);
                else
                    objEmpToBeProcessedList=ListofPersionsToBeProcessed(empType, payDate);
                ...
                if (objEmpToBeProcessedList.Count > 0)
                {
                    ...
                    foreach (DVOPayrollautopay objPayrollautopay in objEmpToBeProcessedList)
                    {
                        ...
                        objPayrollIncomesglobal = LoadPaidIncomes(objPayrollProcess_PayEmployee.EmplCode, objpayautosearchdata, false);
                        //objPayrollIncomesglobal = LoadIncomes(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);
                        objPayrolldeductionsglobal = LoadDeductions(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);
                        objPayrollobligationsglobal = LoadObligations(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);
        ...
        public DataSet GetComparedDedAndOblResult(string empType, string startDate, string endDate,bool IsPrintLetter)
        {
            DataSet dsFinal = new DataSet();
            ...
            {
                #region  Get List of employees processed on 'payDate'
                List<DVOPayrollProcess_PayEmployee> objProcessedEmpList = ListofPersionsProcessed(empType, startDate, endDate);
                ...
                List<DVOPayrollautopay> objEmpToBeProcessedList = new List<DVOPayrollautopay>();
                if (IsPrintLetter)
                    objEmpToBeProcessedList = ListofPersionsToBeProcessed(empType, startDate, endDate, true);
                else
                    objEmpToBeProcessedList = ListofPersionsToBeProcessed(empType, startDate, endDate);
                ...
                if (objEmpToBeProcessedList.Count > 0)
                {
                    ...
                    //LoadAllEmployeeIncomes();
                    LoadAllDeductions();
                    LoadAllded_taxcalc(startDate);
                    LoadAllded_taxcalc_Detail(startDate);
                    LoadAllObligations();
                    LoadAllDupSSN();
                    LoadAllDupSSNPay();
                    //****************************************************************
                    ...
                    List<string> ListofMondays = GetMondays(startDate, endDate);
                    foreach (string strPaydate in ListofMondays)
                    {
                        objpayautosearchdata.Employee_Type = empType;
                        objpayautosearchdata.Payroll_Date = DateTime.ParseExact(strPaydate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);

                        foreach (DVOPayrollautopay objPayrollautopay in objEmpToBeProcessedList)
                        {
                            objPayrollautopay.Payroll_Date = objpayautosearchdata.Payroll_Date;
                            objCurEmpl = objPayrollautopay;
                            objProcessedStypare = new DVOPayrollProcess_PayEmployee();
                            objProcessedStypare = objProcessedEmpList.Find(delegate(DVOPayrollProcess_PayEmployee o) { return (o.EmplCode == objPayrollautopay.EmplCode && o.pay_date == objpayautosearchdata.Payroll_Date); });
                            if (!(objProcessedStypare == null && IsPrintLetter))
                            {
                                ...
                                objPayrollIncomesglobal = LoadPaidIncomes(objPayrollProcess_PayEmployee.EmplCode, objpayautosearchdata, true);
                                //objPayrollIncomesglobal = LoadIncomes(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);
                                objPayrolldeductionsglobal = LoadDeductions(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);
                                objPayrollobligationsglobal = LoadObligations(objPayrollProcess_PayEmployee.EmplCode, objPayrollProcess_PayEmployee.eop_date, objPayrollautopay.FlexDeptAcctType, objPayrollautopay.Flexdeptkeyvalue);
                            ...
                            else
                            {
                                if (!IsPrintLetter)
                                {
                                    ...
                                    //        drtmp["doc_no"] = objPayrollProcess_PayEmployee.Doc_no;
                                    AddIncomesIntoTable(ref objDtlIncoms);
                                    DataRow[] drs = objDtlIncoms.Select("doc_no = 0");
                                    foreach (DataRow drtmp in drs)
                                        drtmp["doc_no"] = objPayrollProcess_PayEmployee.Doc_no;
                                    AddDeductionIntoTable(ref objDtlDeduction);
                                    drs = objDtlDeduction.Select("doc_no = 0");
                                    foreach (DataRow drtmp in drs)
                                        drtmp["doc_no"] = objPayrollProcess_PayEmployee.Doc_no;
                                    AddObligationIntoTable(ref objDtlObligation);
                                    drs = objDtlObligation.Select("doc_no = 0");
                                    foreach (DataRow drtmp in drs)
                                        drtmp["doc_no"] = objPayrollProcess_PayEmployee.Doc_no;
                                }
                            }
        ...
        //public DataTable GetComparedDedAndOblResult(string empType, string payDate)
        //{
        //    #region Make DataTable object to hold Deductions and Obligation Compared Result..
        //    DataTable objDataTable = new DataTable();
        //    objDataTable.TableName = "StyDedObl";
        //    objDataTable.Columns.Add("empl_code");
        //    objDataTable.Columns.Add("first_name");
        //    objDataTable.Columns.Add("middle_name");
        //    objDataTable.Columns.Add("last_name");
        //    objDataTable.Columns.Add("pay_date", typeof(DateTime));
        //    objDataTable.Columns.Add("eop_date", typeof(DateTime));
        //    objDataTable.Columns.Add("doc_no", typeof(int));
        //    objDataTable.Columns.Add("DedObl");
        //    objDataTable.Columns.Add("code");
        //    objDataTable.Columns.Add("prate", typeof(decimal));
        //    objDataTable.Columns.Add("pamount", typeof(decimal));
        //    objDataTable.Columns.Add("crate", typeof(decimal));
        //    objDataTable.Columns.Add("camount", typeof(decimal));
        //    objDataTable.Columns.Add("IsProcessed");
        //    objDataTable.Columns.Add("IsEmpProcessed");
        ...
        //                AddDednOblIntoDataTable(ref objDataTable, IsEmpPrc);
        ...
        public void AddDednOblIntoDataTable(ref DataTable objDataTable, bool IsEmpPrc)
        {

            #region AddDeductions..
            DVOPayrollstypaydd objDedP = null;
            List<DVOPayrollstypaydd> objCurEmpProcessedDedList = objStypayddList.FindAll(delegate(DVOPayrollstypaydd o) { return o.Doc_no == curEmpDocNo; });
            foreach (DVOPayrollstypaydd objC in objPayrolldeductionsglobal)
            {
                ...
                if (objDedP != null)
                {
                    ...
                    dr["eop_date"] = objCurEmpl.EOP_Date;
                    dr["doc_no"] = objDedP.Doc_no;
                    dr["code"] = objDedP.ded_code;

                    if (objDedP.ded_rate != null)
                        dr["prate"] = objDedP.ded_rate;
                    else
                        dr["prate"] = DBNull.Value;

                    if (objDedP.amount != null)
                        dr["pamount"] = objDedP.amount;
                    else
                        dr["pamount"] = DBNull.Value;

                    if (objC.ded_rate != null)
                        dr["crate"] = objC.ded_rate;
                    else
                        dr["crate"] = DBNull.Value;

                    if (objC.amount != null)
                        dr["camount"] = objC.amount;
                    else
                        dr["camount"] = DBNull.Value;
            ...
            foreach (DVOPayrollstypaydd objP in objCurEmpProcessedDedList)
            {
                ...
                dr["eop_date"] = objCurEmpl.EOP_Date;
                dr["doc_no"] = 0;
                dr["code"] = objP.ded_code;

                if (objP.ded_rate != null)
                    dr["prate"] = objP.ded_rate;
                else
                    dr["prate"] = DBNull.Value;

                if (objP.amount != null)
                    dr["pamount"] = objP.amount;
                else
                    dr["pamount"] = DBNull.Value;
            ...
            foreach (DVOPayrollStypayod objC in objPayrollobligationsglobal)
            {
                ...
                if (objOblP != null)
                {
                    ...
                    dr["eop_date"] = objCurEmpl.EOP_Date;
                    dr["doc_no"] = objOblP.Doc_no;
                    dr["code"] = objOblP.obl_code;

                    if (objOblP.obl_rate != null)
                        dr["prate"] = objOblP.obl_rate;
                    else
                        dr["prate"] = DBNull.Value;

                    if (objOblP.amount != null)
                        dr["pamount"] = objOblP.amount;
                    else
                        dr["pamount"] = DBNull.Value;

                    if (objC.obl_rate != null)
                        dr["crate"] = objC.obl_rate;
                    else
                        dr["crate"] = DBNull.Value;
            ...
            foreach (DVOPayrollStypayod objP in objCurEmpProcessedOblList)
            {
                ...
                dr["eop_date"] = objCurEmpl.EOP_Date;
                dr["doc_no"] = 0;
                dr["code"] = objP.obl_code;

                if (objP.obl_rate != null)
                    dr["prate"] = objP.obl_rate;
                else
                    dr["prate"] = DBNull.Value;
        ...
        public List<DVOPayrollstypayid> LoadPaidIncomes(string EmplCode, DVOPayrollautopay objpayautosearchdata, bool shouldMatchAutopayData)
        {
            List<DVOPayrollstypayid> ListStypayid = new List<DVOPayrollstypayid>();
            try
            {
                if (dsAllIncomesPaid != null && dsAllIncomesPaid.Tables.Count > 0)
                {
                    string _selectstat = string.Empty;
                    string _strpaydate = objpayautosearchdata.Payroll_Date.ToString(DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture);

                    if (shouldMatchAutopayData)
                        _selectstat = " empl_code = '" + EmplCode.Trim() + "' and pay_date = #" + _strpaydate + "#";
                    else
                        _selectstat = " empl_code = '" + EmplCode.Trim() + "'";
                    DataRow[] drs = dsAllIncomesPaid.Tables[0].Select(_selectstat);
        ...
        public static List<string> GetMondays(string startDate, string enddate)
        {
            ...
            try
            {
                DateTime sDate = DateTime.ParseExact(startDate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);
                DateTime edate = DateTime.ParseExact(enddate, DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.NoCurrentDateDefault);

                while (sDate <= edate)
                {
                    if (sDate.DayOfWeek.ToString() == "Monday")
                    {
                        objList.Add(sDate.ToString(DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture));
                    }
            ...
            {
                //ExceptionManagement.ExceptionManager(ex);
                throw ex;
            }
            return objList;
        }
