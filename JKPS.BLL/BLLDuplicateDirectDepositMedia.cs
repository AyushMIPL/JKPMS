...
namespace JKPS.BLL
{
    public class BLLDuplicateDirectDepositMedia
    {
        public static DataTable GetDirectDepositeData(ref DVOddmStypddreAndStypddrd objSearch, bool shouldMakeAPEntry)
        {
            DataSet ds = null;
        ...
        public static DataTable GetDirectDepositeDataForMultipleBankCode(ref DVOddmStypddreAndStypddrd objSearch, bool shouldMakeAPEntry, ref System.Collections.ArrayList _arrBankCodes)
        {
            DataSet ds = null;
            string ErrorMessage = string.Empty;
            DALBaseClassHelper objDALBaseClassHelper = new DALBaseClassHelper();
            ...
            try
            {
                ...
                foreach (string strBankCode in _arrBankCodes)
                {
                    ...
                    parametres[1] = objSearch.Date.ToString(DVOApplicationUserInfo.DateFormat, System.Globalization.CultureInfo.InvariantCulture); //payroll Date
                    //parametres[2] = objSearch.GenCheck;
                    ds = objDALBaseClass.GetData(ref parametres, typeof(DVOddmStypddreAndStypddrd), objSearch.GET_DUPLICATE_DDMData);
