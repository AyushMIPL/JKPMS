...
namespace App.Web.Reports {
    ...
    public class rptGrantedRefunds : ReportClass {
        
        public rptGrantedRefunds() {
        }
        
        public override string ResourceName {
            get {
                return "rptGrantedRefunds.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "App.Web.Reports.rptGrantedRefunds.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptGrantedRefunds : Component, ICachedReport {
        
        public CachedrptGrantedRefunds() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptGrantedRefunds rpt = new rptGrantedRefunds();
            rpt.Site = this.Site;
            return rpt;
        }
