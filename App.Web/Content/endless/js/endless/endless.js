...
$(function () {
  ...
  $(document).ready(function () {
    // Hide or close the popup
      $('.logoutConfirm_close').on('click', function () {    
        $('.confirmClass').popup('hide'); 
      });

    $('.confirmDelete_close').on('click', function () {
      debugger
       $('.confirmClass').popup('hide');
      });
   });

  if (document.getElementById("logoutform") != null && document.getElementById("logoutform") != "") {
